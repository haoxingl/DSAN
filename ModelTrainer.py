    ...
    def train(self):
        ...
        with strategy.scope():
            ...
            def train_step(inp_ft, inp_ex, dec_inp_f, dec_inp_ex, cors, y):
                ...
                enc_padding_mask, combined_mask, dec_padding_mask, dec_padding_mask_s = create_masks(inp_ft[..., :2],
                                                                                                     dec_inp_f)

                with tf.GradientTape() as tape:
                    predictions, _ = stsan_xl(inp_ft, inp_ex, dec_inp_f, dec_inp_ex, cors, True,
                                              enc_padding_mask, combined_mask, dec_padding_mask, dec_padding_mask_s)
            ...
            def test_step(inp_ft, inp_ex, dec_inp_f, dec_inp_ex, cors, y, final_test=False):
                ...
                for i in range(args.n_pred):
                    ...
                    enc_padding_mask, combined_mask, dec_padding_mask, dec_padding_mask_s = create_masks(
                        inp_ft[..., :2], targets)
