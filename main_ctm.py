...
parser.add_argument('--test_name', default="npred_1_23")
parser.add_argument('--hyp', default=[1])
parser.add_argument('--run_time', default=1)
parser.add_argument('--BATCH_SIZE', default=128)
parser.add_argument('--local_block_len', default=1)
parser.add_argument('--local_block_len_g', default=2)
...
parser.add_argument('--n_pred', default=1, help='future time to predict')
