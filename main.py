...
parser.add_argument('--test_name', default='cnn_layers', help='indexes of model to be trained')
parser.add_argument('--hyp', default=[6, 5, 4, 3, 2, 1], help='indexes of model to be trained')
