...
parser.add_argument('--test_name', default='dual_weights_09', help='indexes of model to be trained')
parser.add_argument('--hyp', default=[1], help='indexes of model to be trained')
parser.add_argument('--run_time', default=2, help='indexes of model to be trained')
...
parser.add_argument('--weight_1', default=0.9)
parser.add_argument('--weight_2', default=0.1)
