...
parser.add_argument('--test_name', default='dual_weights', help='indexes of model to be trained')
...
parser.add_argument('--weight_1', default=0.8)
parser.add_argument('--weight_2', default=0.2)
