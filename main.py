...
parser.add_argument('--test_name', default="test_dynamic_attender", help='indexes of model to be trained')
...
parser.add_argument('--l_da', default=2, help='num of self-attention layers')
