...
parser.add_argument('--index', default='SOTA_1GPU_64_48000', help='indexes of model to be trained')
...
parser.add_argument('--warmup_steps', default=48000)
parser.add_argument('--verbose_train', default=1)
parser.add_argument('--weights', default=weights)
parser.add_argument('--es_patience', default=10)
parser.add_argument('--es_threshold', default=0.0001)
