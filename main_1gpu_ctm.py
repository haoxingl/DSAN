...
parser.add_argument('--gpu_ids', default='2', help='indexes of gpus to use')
...
parser.add_argument('--remove_old_files', default=False, help='remove old results, checkpoints, and tensorboard')
